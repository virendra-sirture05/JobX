      ...
      <div className="grid gap-12 md:grid-cols-2 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 w-fit rounded-full border border-brand/30 bg-brand/5 px-3 py-1 text-sm text-brand">
            ...
            <span>Trusted Career Referrals</span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900">
            Move Your Career Forward Through Referrals
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-slate-600 max-w-xl">
            Job Referrer System connects talented candidates, employers, and professional referrers to turn the right introductions into real opportunities.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/register">
              <Button size="lg" className="text-base">
                Join Job Referrer System
              </Button>
            </Link>
            <Link to="/register">
              <Button size="lg" variant="outline" className="text-base">
                Refer or Hire Talent
              </Button>
            </Link>
          </div>
          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="aspect-square rounded-2xl bg-linear-to-br from-brand/10 to-slate-100 border border-slate-200 flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-slate-500 font-medium">Your next opportunity starts here</p>
              </div>
            </div>
          </div>
        </div>
